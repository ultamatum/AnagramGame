...
namespace Tile_Engine
{
    public static class TileMap
    {
        ...
        public const int MapWidth = 30;                 //The amount of tiles that go accross the length of the map
        public const int MapHeight = 17;                //The amount of tiles that go accross the height of the map
        public const int MapLayers = 3;                 //The amount of layers the map has.
        private const int skyTile = 26;                  //The tile ID of the sky tile
